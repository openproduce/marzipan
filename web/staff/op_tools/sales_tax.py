...
print_the_stuff(datetime.datetime(2023,7,1), datetime.datetime(2023,8,1))    
print_the_stuff(datetime.datetime(2023,8,1), datetime.datetime(2023,9,1))
print_the_stuff(datetime.datetime(2023,9,1), datetime.datetime(2023,10,1))
print_the_stuff(datetime.datetime(2023,10,1), datetime.datetime(2023,11,1))
print_the_stuff(datetime.datetime(2023,11,1), datetime.datetime(2023,12,1))
print_the_stuff(datetime.datetime(2023,12,1), datetime.datetime(2024,1,1))
